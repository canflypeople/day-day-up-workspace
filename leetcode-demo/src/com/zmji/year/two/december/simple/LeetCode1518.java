...
/**
 * 1518. 换酒问题 小区便利店正在促销，用 numExchange 个空酒瓶可以兑换一瓶新酒。你购入了 numBottles 瓶酒。
 *
 ...
 * 提示：
 *
 * 1 <= numBottles <= 100 2 <= numExchange <= 100 通过次数28,142提交次数41,271
 * 
 * @author : zhongmou.ji
 * @date : 2021/12/17 8:10 上午
 **/
public class LeetCode1518 {
    public int numWaterBottles(int numBottles, int numExchange) {
        ...
        while (emptyBottles / numExchange > 0) {
            int drinkBottles = emptyBottles / numExchange;
            res += drinkBottles;
            emptyBottles = drinkBottles + emptyBottles % numExchange;
        }
        return res;

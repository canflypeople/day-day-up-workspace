...
/**
 * 859. 亲密字符串 给你两个字符串 s 和 goal ，只要我们可以通过交换 s 中的两个字母得到与 goal 相等的结果，就返回 true ；否则返回 false 。
 *
 ...
 * 
 * @author : zhongmou.ji
 * @date : 2021/11/23 上午8:00
 **/
public class LeetCode859 {

    public boolean buddyStrings(String s, String goal) {
        // 遍历
        if (!Objects.equals(s.length(), goal.length())) {
            return false;
        }
        ...
        if (Objects.equals(s, goal)) {
            ...
            /**
             * 比较巧妙，如果循环变量不是很多的话， 可以设置两个变量指针，通过这个来控制...
             */
